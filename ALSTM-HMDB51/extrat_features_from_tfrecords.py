...
tfrecords_path = '/raid/Attention/tfrecords/'

tf_all = tfrecords_path + 'ucf11_train_split2.tfrecords'
tf1 = tfrecords_path+'train_split1.tfrecords'
tf2 = tfrecords_path+'train_split2.tfrecords'
tf3 = tfrecords_path+'train_split3.tfrecords'
#tf4 = tfrecords_path+'train_split4.tfrecords'
tfrecords_list = [tf_all]
...
def generate_feature_batch_and_label_batch(batch_size):
    ...
    example_list = [read_single_sample(tfrecords_list) for _ in range(12)]
