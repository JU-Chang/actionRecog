% ExtractSpatialCNNFeature_ucf101('spatial',3,0)

function ExtractSpatialCNNFeature_ucf101(tag,scale,gpu_id)
...
%     addpath /home/chang/caffe-action_recog/matlab/
  ...
  % ################################################### %
    feat_path = ['/data/UCF101/',tag,'CnnFeature'];
    video_path = '/data/UCF101/UCF-101';
    log_file = ['/data/UCF101/',tag,'CnnFeature.log'];
  % ################################################### %
