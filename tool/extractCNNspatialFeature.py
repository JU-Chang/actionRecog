...
frame_image_path = '/home/wyd/workspace/h51/frame_image/'
...
tf.app.flags.DEFINE_string(
    'model_dir', '/home/wyd/workspace/h51/GoogleLeNet',
...
tfrecords_path = '/home/wyd/workspace/h51/tfrecords/'
...
def run_inference_on_image():
    ...
    with tf.Session() as sess:
        ...
        featrue_maps = []
        for i in os.listdir('/home/wyd/workspace/h51/frame_image'):
...
def get_features_matrix(frame_matrix):
    ...
    for each_frame in frame_matrix:
        cv2.imwrite('/home/wyd/workspace/h51/frame_image/frame_' + str(i) + '.jpg', each_frame)
        i += 1
